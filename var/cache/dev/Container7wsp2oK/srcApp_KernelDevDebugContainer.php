...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_2d6da92af76b37a8ccef6463c1f0847d4fb8b487a16c126561f1605ae7d12c70');
    ...
    protected function getFosRest_FormatListenerService()
    {
        ...
        $a->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api', NULL, NULL, NULL, []), ['fallback_format' => 'json', 'priorities' => [0 => 'json'], 'methods' => NULL, 'attributes' => [], 'stop' => false, 'prefer_extension' => '2.0']);
